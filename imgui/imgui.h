...
namespace ImGui
{
    ...
    IMGUI_API void          DefaultStyleColors(ImGuiStyle* dst = NULL);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_MainMenu               = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoSavedSettings,
    ImGuiWindowFlags_SubMainMenu = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoSavedSettings,
